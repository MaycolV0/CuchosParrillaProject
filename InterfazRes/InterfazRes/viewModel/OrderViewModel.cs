...
namespace InterfazRes.viewModel
{
    public class OrderViewModel : BaseViewModel
    {
        ...
        public List<Pick> GetMenu()
        {
            ...
            {
                new Pick{Title="Camarones", Image="https://imgur.com/HFqbpnv.png", Description="Camarones apanados. ", Price="13,900"},
                ...
                new Pick{Title="Pollo Apanado", Image="https://imgur.com/aWv6nPS.png", Description="Pollo apanado y papas a la francesa.", Price="10,900"},
                new Pick{Title="Pollo Apanado #2", Image="https://imgur.com/AmDySlJ.png", Description="Pollo apanado y papas a la francesa.", Price="8,000"},
                new Pick{Title="Salchichas", Image="https://imgur.com/rgcnPVX.png", Description="Salchichas y papas a la francesa.", Price="8,000"},
